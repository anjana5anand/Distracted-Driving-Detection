...
train_features_root = '/media/viplab/Storage1/driver_action_recognition/raw_features_all/A1/train'
train_labels_root = '/media/viplab/DATADRIVE1/driver_action_recognition/arrays'

validation_features_root = '/media/viplab/Storage1/driver_action_recognition/raw_features_all/A1/valid'
validation_labels_root = '/media/viplab/DATADRIVE1/driver_action_recognition/arrays'

num_epochs = 100
weights_save_path = "/media/viplab/DATADRIVE1/driver_action_recognition/mamba_weights_all"
...
def train_mamba(
    ...
    for epoch in range(num_epochs):
        ...
        avg_train_loss = total_loss / len(valid_loader)
