...
num_epochs = 100
weights_save_path = "mamba_weights_all_300"
...
class MambaSequenceClassifier(nn.Module):
    def __init__(self, input_dim=2048, hidden_dim=1024, num_classes=16):
        super().__init__()
...
model = MambaSequenceClassifier(input_dim=2048, hidden_dim=1024, num_classes=16)
