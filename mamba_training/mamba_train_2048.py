...
num_epochs = 100
weights_save_path = "mamba_weights_2048_150"
...
class ChunkedVideoDataset(Dataset):
    def __init__(self, base_dataset, chunk_size=150, stride=75):
...
train_dataset = ChunkedVideoDataset(t_dataset, chunk_size=150)
...
def train_mamba(
    ...
    for epoch in range(num_epochs):
        ...
        if val_accuracy > best_val_accuracy:
            ...
            # (model.state_dict(), f"{weights_save_path}/mamba_best.pth")
