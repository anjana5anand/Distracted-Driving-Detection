...
def extract_features_from_video(video_path, model_path, view):
    ...
    features = []
    frame_idx = 0
    model = ViTMAEForPreTraining.from_pretrained(model_path, mask_ratio=0, torch_dtype=torch.float16)
...
if __name__ == '__main__':
    ...
    output_root = "/media/viplab/DATADRIVE1/driver_action_recognition/vitmae_features/A1_changed"
