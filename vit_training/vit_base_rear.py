...
epochs = 5
learning_rate = 1e-6
weights_save_dir = "/media/viplab/DATADRIVE1/driver_action_recognition/vit_base_weights/rear"
best_val_accuracy = 0
view = "rear"
all_images_paths = "/media/viplab/Storage1/driver_action_recognition/crop_new/cut_frames_rear"
log_file_path = "/media/viplab/DATADRIVE1/driver_action_recognition/vit_base_weights/rear/rear_logs_resnet.txt"
