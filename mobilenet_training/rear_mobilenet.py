...
# %%
all_images_paths = "/media/viplab/DATADRIVE1/driver_action_recognition/mobilenet_approach/cut_frames_rear"
image_paths = []
labels = []
...
log_file_path = "../logs/rear_logs.txt"
...
for epoch in range(epochs):
    ...
    os.system(f'echo "Best Side Weight {best_epoch}" > best_rear_epoch.txt')
