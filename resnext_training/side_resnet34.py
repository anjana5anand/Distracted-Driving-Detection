...
epochs = 10
learning_rate = 2e-6
weights_save_dir = "/media/viplab/DATADRIVE1/driver_action_recognition/resnet_weights/side"
best_val_accuracy = 0
view = "side"
all_images_paths = "/media/viplab/Storage1/driver_action_recognition/crop_new/cut_frames_side"
log_file_path = "/media/viplab/DATADRIVE1/driver_action_recognition/resnet_weights/side/side_logs_resnet.txt"
...
for epoch in range(epochs):
    ...
    os.system(f'echo "Best side Weight {best_epoch}" > best_sided_epoch.txt')
