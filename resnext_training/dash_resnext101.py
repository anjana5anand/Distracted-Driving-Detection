...
epochs = 100
learning_rate = 2e-6
weights_save_dir = "/media/viplab/DATADRIVE1/driver_action_recognition/resnext101_weights/dash"
best_val_accuracy = 0
view = "dash"
all_images_paths = "/media/viplab/Storage1/driver_action_recognition/crop_new/cut_frames_dash"
log_file_path = "/media/viplab/DATADRIVE1/driver_action_recognition/resnext101_weights/dash/dash_logs_resnet.txt"
...
class ResNetClassifier(nn.Module):
    def __init__(self, num_classes):
        ...
        self.model = models.resnext101_64x4d(weights=models.ResNeXt101_64X4D_Weights.IMAGENET1K_V1)
