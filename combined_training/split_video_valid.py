...
data_dir = '/media/viplab/DATADRIVE1/driver_action_recognition/crop_video/valid'
output_dir = '/media/viplab/DATADRIVE1/driver_action_recognition/split_video/valid'
